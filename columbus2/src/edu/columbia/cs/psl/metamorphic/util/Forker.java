...
/**
 * This class is responsible for invoking a UNIX fork method through JNI.
 */
...
public class Forker {
	...
	/**
	 * This method calls the native doFork method and returns the process id of
	 * this particular process. The child will have a pid of 0, the parent's
	 * will be unchanged.
	 */
	public static int fork() {
		 ...
		 * 
		 * // if the pid is 0, then you're the child if (pid == 0)
		 * System.out.println("Child " + pid); else System.out.println("Parent "
		 * + pid);
		 **/
