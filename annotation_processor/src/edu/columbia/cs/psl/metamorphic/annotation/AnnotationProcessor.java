...
import edu.columbia.cs.psl.metamorphic.compiler.AnnotatedClass;
import edu.columbia.cs.psl.metamorphic.compiler.CompilerMethodVisitor;
...
//				bw.newLine();
	...
	private String formatRule(String methodName, String rule) {
		...
		rule = m.replaceAll("new edu.columbia.cs.psl.metamorphic.inputProcessor.impl.$1().apply(");
